...
- 📄 **Domain Detail** — In-depth info, skills, and resources for each domain
- 🗺️ **Roadmaps** — Step-by-step learning roadmap for every domain
- 🧠 **Career Finder Quiz** — Diagnostic quiz to recommend the best-fit career domain
- 📊 **Results & History** — View past quiz results with confidence scores
